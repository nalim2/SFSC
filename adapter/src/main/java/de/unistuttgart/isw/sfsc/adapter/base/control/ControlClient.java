package de.unistuttgart.isw.sfsc.adapter.base.control;

import de.unistuttgart.isw.sfsc.adapter.base.BootstrapConfiguration;
import de.unistuttgart.isw.sfsc.adapter.base.control.registry.AdapterRegistryClient;
import de.unistuttgart.isw.sfsc.adapter.base.control.registry.RegistryClient;
import de.unistuttgart.isw.sfsc.adapter.base.control.session.SessionManager;
import de.unistuttgart.isw.sfsc.adapter.base.control.session.SimpleSessionManager;
...
public class ControlClient implements AutoCloseable {
  ...
  public static ControlClient create(Reactor reactor, BootstrapConfiguration configuration) throws ExecutionException, InterruptedException {
    ...
    inboxTopicManager.addTopicListener(registryClient);

    ReactiveInbox reactiveDataInbox = ReactiveInbox.create(pubSubConnection.dataInbox(), inboxTopicManager);
